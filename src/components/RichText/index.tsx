...
type NodeTypes = DefaultNodeTypes | SerializedBlockNode<MediaBlockProps | InlineMediaBlockProps>
...
const textNodeFormatter: (arg: { node: SerializedTextNode }) => JSX.Element = ({
  node: { text, style: nodeStyle, format },
}) => {
  const defaultStyle = {
    textDecoration:
...
const jsxConverters: JSXConvertersFunction<NodeTypes> = ({ defaultConverters }) => ({
  ...
  blocks: {
    ...
    videoEmbedBlock: ({ node }: { node: SerializedBlockNode<VideoEmbedBlockType> }) => (
      <VideoEmbedBlock {...node.fields} />
    ),
  },
})
